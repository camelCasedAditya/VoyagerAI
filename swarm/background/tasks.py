...
def plan_trip(prompt, trip_id):
    ...
    agent = create_agent(
        ...
        system_prompt="""
            ...
            - find_food_places(address: str, radius: int = 5000, limit: int = 10) -> list: This tool takes an address string (or a "lat,lng" pair), an optional radius in meters, and an optional limit on results, and returns a list of nearby restaurants as plain-text entries.
